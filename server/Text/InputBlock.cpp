...
InputBlock::InputBlock(TTF_Font *_font, int _x, int _y, SDL_Color _textColor, bool _isVisible, SDL_Renderer *render) {
	text = "";
	font = _font;
	sprite.x = _x;
	sprite.y = _y;
